...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        height: an integer > 0
        """
        assert (width > 0 and height > 0), "Width and Height must be more than zero"
        ...
        for i in range(width):
            self.tiles.append([False for j in range(height)])
    ...
    def cleanTileAtPosition(self, pos):
        ...
        if self.tiles[int(pos.getX())][int(pos.getY())] == True:
            return
        else:
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        assert (isinstance(m, int) and isinstance(n, int)), 'Both parameters must be ints'
    ...
    def isPositionInRoom(self, pos):
        ...
        if pos.getX() < float(self.width) and pos.getY() < float(self.height):
            return True
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        """
        #assert isinstance(speed, float), 'Speed is not a float'
        assert isinstance(room, RectangularRoom), 'room is not an instance of RectangularRoom'
    ...
    def setRobotDirection(self, direction):
        ...
        """
        assert (0 <= direction < 360), 'Direction is not valid'
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        while room.getNumCleanedTiles() / float((width * height)) < min_coverage:
    ...
    return time_step_count / float(num_trials)
